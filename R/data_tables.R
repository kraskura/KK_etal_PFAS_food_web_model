...
create_data_tables<-function(
  ...
  if(is.null(nu_NB)){
    ...
    for (i in 1:length(species)){
      ...
      if(group_species[i] == "bird"){
       nu_NB <- append(nu_NB, 0.05)
      } 
    }
  }else{
  ...
  if(is.null(epsilon_N)){
    ...
    for (i in 1:length(species)){
      ...
      if(group_species[i] == "bird"){
       epsilon_N <- append(epsilon_N, 1)# test
      } 
    }
  }else{
  ...
  if(is.null(epsilon_L)){
    ...
    for (i in 1:length(species)){
      ...
      if(group_species[i] == "bird"){
       epsilon_L <- append(epsilon_L, 1)# tests
      } 
    }
  }else{
  ...
  if(is.null(epsilon_P)){
    ...
    for (i in 1:length(species)){
      ...
      if(group_species[i] == "bird"){
       epsilon_P <- append(epsilon_P, 1)# test
      } 
    }
  }else{
  ...
  if(is.null(MMR)){
    ...
    for (i in 1:length(species)){
      if(group_species[i] == "plant" |
         group_species[i] == "inv" |
         group_species[i] == "fish" | 
         group_species[i] == "bird"){
       MMR <- append(MMR, NA)
      }
    }
  }else{
  ...
  for (i in 1:length(species)){
    ...
    if(group_species[i] == "inv"){
     switchG_D <- append(switchG_D, 4)
    } 
    if(group_species[i] == "fish" ){
     switchG_D <- append(switchG_D, 1)
    }
    if(group_species[i] == "bird" ){
     switchG_D <- append(switchG_D, 3)
    } 
  }
  switchk_R<-vector()
  for (i in 1:length(species)){
...
# print(c("6pb",nu_OB))
# print(c("7nuwB",nu_WB))
# print(c("8n",epsilon_N))
# print(c("9l",epsilon_L))
# print(c("10p",epsilon_P))
# print(c("10o",epsilon_O))
# print(c("11w",epsilon_W))
# print(c("12a",A))
# print(c("13b",B))
# print(c("14grf",GRF))
# print(c("15k1",switchk_1))
# print(c("16k_d",switchG_D))
# print(c("17k_R",switchk_R))
# print(c("18mmr",MMR))
# print(c("19rmr",RMR))
# print(c("20pctfeed",pct_FeedRate))
# print(c("21scale exp",scaling_exp))
# print(c("22feed exp",feeding_exp))
# print(c("23PB", P_B))
# print(length(species))
  
  organismData <- as.data.frame(matrix(data = 
                                         c( WB_kg, m_O, nu_NB, nu_LB, nu_PB, nu_OB, # 6
                                           nu_WB, epsilon_N, epsilon_L, epsilon_P,# 10
                                           epsilon_O, epsilon_W, A, B,# 14
                                           GRF, switchk_1, switchG_D, switchk_R,# 6
  ...
  if(system_type == "aquatic"){
    colnames(foodWebData)<-c("Sed", names( foodWeb))
  }
  if(system_type == "terrestrial"){
    colnames(foodWebData)<-c("Soi", names( foodWeb))
  }
  
  # print(c("check foodweb data"))
  ...
  numSpecies<-length(species)# assuming sediment or soil is always there 
  foodWebData<-as.data.frame(foodWebData)
  dietData<-as.data.frame(dietData)
  if(!is.null(kRTable)){
    kRTable<-as.data.frame(kRTable) 
  }
