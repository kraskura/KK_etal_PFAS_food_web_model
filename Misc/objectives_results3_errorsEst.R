...
## ----source, warning=FALSE, message=FALSE, echo=TRUE----------------------------------------------------
...
source(here("Code/R model/fnx_MonteCarlo.R"))
...
## ----mcmc run modeled, eval=FALSE, message = TRUE-------------------------------------------------------
...
## ----mcmc run observed , eval=FALSE, message = FALSE----------------------------------------------------
## settings_obsDiet = new_Settings(
##   chooseDiet = 'forced',
## )
## 
...
## ----read in and organisze saved data-------------------------------------------------------------------
...
## ----visualizing results plot1, fig.height = 9, fig.width=6, eval = T-----------------------------------
...
## ----visualizing results plot2, fig.height = 12, fig.width=6--------------------------------------------
...
## ----visualizing full results modeled PFAA diet, fig.height=3.5, fig.width=9.5--------------------------
...
## ----visualizing full results observed PFAA diet, fig.height=3.5, fig.width=9.5-------------------------
# DataList$PFAA<-factor(DataList$PFAA)
...
## ----species prediction, fig.height=3.5, fig.width=9.5--------------------------------------------------
...
## ----the effects of temperature, eval = FALSE-----------------------------------------------------------
## 
## 
## for (i in 1:length(PFAS_List)){
## 
