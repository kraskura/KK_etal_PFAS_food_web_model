...
# save data
write.csv(x = data_l[!data_l$Subject_Taxonomic_Name == "water",], file = here("Data", "MDE", "Kraskura_MDE_fish_longformat_042024.csv"))
write.csv(x = d_water, file = here("Data", "MDE", "Kraskura_MDE_water_longformat_042024.csv"))
write.csv(x = data_tot, file = here("Data", "MDE", "Kraskura_MDE_sumPFAS_longformat_042024.csv"))
```
