---
title: "Data Tables"
subtitle: "Willow Grove (Navy Rec Pond), Joint Base Andrew's (JBA) (Air Force Base Creek). All data show median values of the season"
...
```{r source files, echo = FALSE, message=FALSE, warning=FALSE}
...
source(here("Code/R data tables/WG_spring.R"))
data.wg.sp<-inputFiles_list
source(here("Code/R data tables/WG_fallWinter.R"))
data.wg.fall<-inputFiles_list
source(here("Code/R data tables/WG_summer.R"))
data.wg.sum<-inputFiles_list
