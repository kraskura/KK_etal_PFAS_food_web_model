...
library(readxl)
library(here)
here::i_am(path = "./Code/R data tables/WG_invert_fw.R")
...
inputFiles_list<-create_data_tables(
  species = c("Phy", "Zpl", "Cru", "Ins", "Wor",	"Pry", "Bgl", "Bas"),
  group_species = c("plant", "inv", "inv", "inv", "inv", "fish", "fish", "fish"), 
  WB_kg = unlist(c(NA,
                   0.0000001,
                   0.00001,
                   0.00001, 
  ...
  m_O = c(1, 1,1, 1, 1, 1, 1, 1),
  # P_B = c(0.5, 0.1, 0.1, 0.15, 0.15, 0.15),
  foodWeb = list(
Phy = c(1,0,0,0,0,0,0,0,0),
Zpl = c(0,1,0,0,0,0,0,0,0),
Cru = c(0.1,0.45,0.45,0,0,0,0,0,0),
Ins = c(0.1,0.4,0.5,0,0,0,0,0,0),
Wor = c(0.9,0.05,0.05,0,0,0,0,0,0),
Pry = c(0,0.01,0.11,0.1,0,0.01,0,0,0),
Bgl = c(0,0,0.06,0.1,0.01,0,0,0,0),
Bas = c(0,0,0.001,0.08,0.01,0,0.1,0,0)
      ),
  diet = list(
    Zpl = c(0,0,0,0,0,0),
    Cru = c(0,0,0,0,0,0),
