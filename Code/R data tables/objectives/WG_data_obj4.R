...
inputFiles_list<-create_data_tables(
  ...
  # RMR = c(NA, 0.700002442*24, 8.87*24, 31.79186943*24), # in mgO2/d whole fish
  scaling_exp = c(0.89, 0.89, 0.89, 0.89),
  # feeding_exp = c(0.65, 0.6, 0.7, 0.7),
